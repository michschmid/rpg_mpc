...
int main( ){
  ...
  */
  ...
  Function              h, hN;
  OnlineData            p_F_x1, p_F_y1, p_F_z1, p_F_x2, p_F_y2, p_F_z2;
  ...
  // TODO: duplicate the point of interest state for prototyping
  ...
  // TODO: the translation part is not implemented!
  ...
  h << p_x << p_y << p_z
    << q_w << q_x << q_y << q_z
    << v_x << v_y << v_z
    << intSy1/(intSz1 + epsilon) << intSy2/(intSz2 + epsilon) 
    << T << w_x << w_y << w_z;
