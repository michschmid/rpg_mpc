...
/** Matrix of size: 2 x 160 (row major format) */
real_t rk_diffsTemp2[ 320 ];
...
out[9] = (((((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*u[0])-(real_t)(9.8065999999999995e+00))+((real_t)(1.0000000000000001e-09)*u[4]))+((real_t)(1.0000000000000001e-09)*u[5]));
}
...
out[52] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-u[1]));
out[53] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-u[2]));
out[54] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-u[3]));
...
out[59] = ((real_t)(5.0000000000000000e-01)*(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*xd[4]));
out[60] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[5]));
out[61] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[6]));
...
out[67] = ((real_t)(5.0000000000000000e-01)*u[1]);
out[68] = (real_t)(0.0000000000000000e+00);
out[69] = ((real_t)(5.0000000000000000e-01)*u[3]);
out[70] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-u[2]));
...
out[75] = ((real_t)(5.0000000000000000e-01)*xd[3]);
out[76] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[6]));
out[77] = ((real_t)(5.0000000000000000e-01)*xd[5]);
...
out[91] = ((real_t)(5.0000000000000000e-01)*xd[6]);
out[92] = ((real_t)(5.0000000000000000e-01)*xd[3]);
out[93] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[4]));
...
out[99] = ((real_t)(5.0000000000000000e-01)*u[3]);
out[100] = ((real_t)(5.0000000000000000e-01)*u[2]);
out[101] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-u[1]));
...
out[107] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[5]));
out[108] = ((real_t)(5.0000000000000000e-01)*xd[4]);
out[109] = ((real_t)(5.0000000000000000e-01)*xd[3]);
...
out[115] = (((real_t)(2.0000000000000000e+00)*xd[5])*u[0]);
out[116] = (((real_t)(2.0000000000000000e+00)*xd[6])*u[0]);
out[117] = (((real_t)(2.0000000000000000e+00)*xd[3])*u[0]);
out[118] = (((real_t)(2.0000000000000000e+00)*xd[4])*u[0]);
out[119] = (real_t)(0.0000000000000000e+00);
out[120] = (real_t)(0.0000000000000000e+00);
out[121] = (real_t)(0.0000000000000000e+00);
out[122] = ((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])));
...
out[131] = (((real_t)(2.0000000000000000e+00)*((real_t)(0.0000000000000000e+00)-xd[4]))*u[0]);
out[132] = (((real_t)(2.0000000000000000e+00)*((real_t)(0.0000000000000000e+00)-xd[3]))*u[0]);
out[133] = (((real_t)(2.0000000000000000e+00)*xd[6])*u[0]);
out[134] = (((real_t)(2.0000000000000000e+00)*xd[5])*u[0]);
out[135] = (real_t)(0.0000000000000000e+00);
out[136] = (real_t)(0.0000000000000000e+00);
out[137] = (real_t)(0.0000000000000000e+00);
out[138] = ((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])));
...
out[148] = (((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])+((real_t)(2.0000000000000000e+00)*xd[4])))*u[0]);
out[149] = (((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[5])+((real_t)(2.0000000000000000e+00)*xd[5])))*u[0]);
...
out[154] = (((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]));
out[155] = (real_t)(0.0000000000000000e+00);
out[156] = (real_t)(0.0000000000000000e+00);
out[157] = (real_t)(0.0000000000000000e+00);
out[158] = (real_t)(1.0000000000000001e-09);
out[159] = (real_t)(1.0000000000000001e-09);
}
...
rk_xxx[10] = rk_eta[170];
rk_xxx[11] = rk_eta[171];
rk_xxx[12] = rk_eta[172];
rk_xxx[13] = rk_eta[173];
rk_xxx[14] = rk_eta[174];
rk_xxx[15] = rk_eta[175];
rk_xxx[16] = rk_eta[176];
rk_xxx[17] = rk_eta[177];
rk_xxx[18] = rk_eta[178];
rk_xxx[19] = rk_eta[179];
rk_xxx[20] = rk_eta[180];
rk_xxx[21] = rk_eta[181];
rk_xxx[22] = rk_eta[182];
rk_xxx[23] = rk_eta[183];
rk_xxx[24] = rk_eta[184];
rk_xxx[25] = rk_eta[185];
rk_xxx[26] = rk_eta[186];
rk_xxx[27] = rk_eta[187];
rk_xxx[28] = rk_eta[188];
...
acado_diffs( rk_xxx, &(rk_diffsTemp2[ run1 * 160 ]) );
for (j = 0; j < 10; ++j)
{
tmp_index1 = (run1 * 10) + (j);
rk_A[tmp_index1 * 20] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16)];
rk_A[tmp_index1 * 20 + 1] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 1)];
rk_A[tmp_index1 * 20 + 2] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 2)];
rk_A[tmp_index1 * 20 + 3] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 3)];
rk_A[tmp_index1 * 20 + 4] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 4)];
rk_A[tmp_index1 * 20 + 5] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 5)];
rk_A[tmp_index1 * 20 + 6] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 6)];
rk_A[tmp_index1 * 20 + 7] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 7)];
rk_A[tmp_index1 * 20 + 8] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 8)];
rk_A[tmp_index1 * 20 + 9] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 9)];
if( 0 == run1 ) rk_A[(tmp_index1 * 20) + (j)] -= 1.0000000000000000e+00;
rk_A[tmp_index1 * 20 + 10] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16)];
rk_A[tmp_index1 * 20 + 11] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 1)];
rk_A[tmp_index1 * 20 + 12] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 2)];
rk_A[tmp_index1 * 20 + 13] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 3)];
rk_A[tmp_index1 * 20 + 14] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 4)];
rk_A[tmp_index1 * 20 + 15] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 5)];
rk_A[tmp_index1 * 20 + 16] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 6)];
rk_A[tmp_index1 * 20 + 17] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 7)];
rk_A[tmp_index1 * 20 + 18] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 8)];
rk_A[tmp_index1 * 20 + 19] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 160) + (j * 16 + 9)];
...
for (i = 0; i < 2; ++i)
{
rk_b[i * 10] = - rk_diffsTemp2[(i * 160) + (run1)];
rk_b[i * 10 + 1] = - rk_diffsTemp2[(i * 160) + (run1 + 16)];
rk_b[i * 10 + 2] = - rk_diffsTemp2[(i * 160) + (run1 + 32)];
rk_b[i * 10 + 3] = - rk_diffsTemp2[(i * 160) + (run1 + 48)];
rk_b[i * 10 + 4] = - rk_diffsTemp2[(i * 160) + (run1 + 64)];
rk_b[i * 10 + 5] = - rk_diffsTemp2[(i * 160) + (run1 + 80)];
rk_b[i * 10 + 6] = - rk_diffsTemp2[(i * 160) + (run1 + 96)];
rk_b[i * 10 + 7] = - rk_diffsTemp2[(i * 160) + (run1 + 112)];
rk_b[i * 10 + 8] = - rk_diffsTemp2[(i * 160) + (run1 + 128)];
rk_b[i * 10 + 9] = - rk_diffsTemp2[(i * 160) + (run1 + 144)];
}
if( 0 == run1 ) {
det = acado_solve_dim20_system( rk_A, rk_b, rk_dim20_perm );
}
...
rk_b[tmp_index1] = - rk_diffsTemp2[(i * 160) + (tmp_index2 + 10)];
}
}
acado_solve_dim20_system_reuse( rk_A, rk_b, rk_dim20_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 10; ++i)
{
rk_diffsNew2[(i * 16) + (run1 + 10)] = + rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
...
{
tmp_index2 = (j) + (i * 10);
rk_eta[tmp_index2 + 10] = rk_diffsNew2[(i * 16) + (j)];
}
for (j = 0; j < 6; ++j)
{
tmp_index2 = (j) + (i * 6);
rk_eta[tmp_index2 + 110] = rk_diffsNew2[(i * 16) + (j + 10)];
}
}
resetIntegrator = 0;
