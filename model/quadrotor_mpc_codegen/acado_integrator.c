...
/** Matrix of size: 2 x 176 (row major format) */
real_t rk_diffsTemp2[ 352 ];

/** Matrix of size: 11 x 2 (row major format) */
real_t rk_diffK[ 22 ];

/** Matrix of size: 11 x 16 (row major format) */
real_t rk_diffsNew2[ 176 ];
...
out[60] = ((real_t)(5.0000000000000000e-01)*(((real_t)(0.0000000000000000e+00)-(real_t)(1.0000000000000000e+00))*xd[4]));
out[61] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[5]));
out[62] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[6]));
...
out[76] = ((real_t)(5.0000000000000000e-01)*xd[3]);
out[77] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[6]));
out[78] = ((real_t)(5.0000000000000000e-01)*xd[5]);
...
out[92] = ((real_t)(5.0000000000000000e-01)*xd[6]);
out[93] = ((real_t)(5.0000000000000000e-01)*xd[3]);
out[94] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[4]));
...
out[108] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[5]));
out[109] = ((real_t)(5.0000000000000000e-01)*xd[4]);
out[110] = ((real_t)(5.0000000000000000e-01)*xd[3]);
...
out[123] = ((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])));
...
out[139] = ((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])));
...
out[155] = (((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]));
...
rk_xxx[11] = rk_eta[187];
rk_xxx[12] = rk_eta[188];
rk_xxx[13] = rk_eta[189];
rk_xxx[14] = rk_eta[190];
rk_xxx[15] = rk_eta[191];
rk_xxx[16] = rk_eta[192];
rk_xxx[17] = rk_eta[193];
rk_xxx[18] = rk_eta[194];
rk_xxx[19] = rk_eta[195];
rk_xxx[20] = rk_eta[196];
rk_xxx[21] = rk_eta[197];
rk_xxx[22] = rk_eta[198];
rk_xxx[23] = rk_eta[199];
rk_xxx[24] = rk_eta[200];
rk_xxx[25] = rk_eta[201];
rk_xxx[26] = rk_eta[202];
rk_xxx[27] = rk_eta[203];
rk_xxx[28] = rk_eta[204];
...
acado_diffs( rk_xxx, &(rk_diffsTemp2[ run1 * 176 ]) );
for (j = 0; j < 11; ++j)
{
tmp_index1 = (run1 * 11) + (j);
rk_A[tmp_index1 * 22] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16)];
rk_A[tmp_index1 * 22 + 1] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 1)];
rk_A[tmp_index1 * 22 + 2] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 2)];
rk_A[tmp_index1 * 22 + 3] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 3)];
rk_A[tmp_index1 * 22 + 4] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 4)];
rk_A[tmp_index1 * 22 + 5] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 5)];
rk_A[tmp_index1 * 22 + 6] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 6)];
rk_A[tmp_index1 * 22 + 7] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 7)];
rk_A[tmp_index1 * 22 + 8] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 8)];
rk_A[tmp_index1 * 22 + 9] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 9)];
rk_A[tmp_index1 * 22 + 10] = + acado_Ah_mat[run1 * 2]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 10)];
if( 0 == run1 ) rk_A[(tmp_index1 * 22) + (j)] -= 1.0000000000000000e+00;
rk_A[tmp_index1 * 22 + 11] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16)];
rk_A[tmp_index1 * 22 + 12] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 1)];
rk_A[tmp_index1 * 22 + 13] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 2)];
rk_A[tmp_index1 * 22 + 14] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 3)];
rk_A[tmp_index1 * 22 + 15] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 4)];
rk_A[tmp_index1 * 22 + 16] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 5)];
rk_A[tmp_index1 * 22 + 17] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 6)];
rk_A[tmp_index1 * 22 + 18] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 7)];
rk_A[tmp_index1 * 22 + 19] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 8)];
rk_A[tmp_index1 * 22 + 20] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 9)];
rk_A[tmp_index1 * 22 + 21] = + acado_Ah_mat[run1 * 2 + 1]*rk_diffsTemp2[(run1 * 176) + (j * 16 + 10)];
...
for (i = 0; i < 2; ++i)
{
rk_b[i * 11] = - rk_diffsTemp2[(i * 176) + (run1)];
rk_b[i * 11 + 1] = - rk_diffsTemp2[(i * 176) + (run1 + 16)];
rk_b[i * 11 + 2] = - rk_diffsTemp2[(i * 176) + (run1 + 32)];
rk_b[i * 11 + 3] = - rk_diffsTemp2[(i * 176) + (run1 + 48)];
rk_b[i * 11 + 4] = - rk_diffsTemp2[(i * 176) + (run1 + 64)];
rk_b[i * 11 + 5] = - rk_diffsTemp2[(i * 176) + (run1 + 80)];
rk_b[i * 11 + 6] = - rk_diffsTemp2[(i * 176) + (run1 + 96)];
rk_b[i * 11 + 7] = - rk_diffsTemp2[(i * 176) + (run1 + 112)];
rk_b[i * 11 + 8] = - rk_diffsTemp2[(i * 176) + (run1 + 128)];
rk_b[i * 11 + 9] = - rk_diffsTemp2[(i * 176) + (run1 + 144)];
rk_b[i * 11 + 10] = - rk_diffsTemp2[(i * 176) + (run1 + 160)];
}
if( 0 == run1 ) {
det = acado_solve_dim22_system( rk_A, rk_b, rk_dim22_perm );
}
...
rk_b[tmp_index1] = - rk_diffsTemp2[(i * 176) + (tmp_index2 + 11)];
}
}
acado_solve_dim22_system_reuse( rk_A, rk_b, rk_dim22_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 11; ++i)
{
rk_diffsNew2[(i * 16) + (run1 + 11)] = + rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
...
{
tmp_index2 = (j) + (i * 11);
rk_eta[tmp_index2 + 11] = rk_diffsNew2[(i * 16) + (j)];
}
for (j = 0; j < 5; ++j)
{
tmp_index2 = (j) + (i * 5);
rk_eta[tmp_index2 + 132] = rk_diffsNew2[(i * 16) + (j + 11)];
}
}
resetIntegrator = 0;
